.. PyCav documentation master file, created by
   sphinx-quickstart on Wed Jul 13 16:38:20 2016.
...
The table of contents is in the left sidebar, and developement can be followed at `PyCav module repository <https://github.com/PyCav/PyCav-Module>`_.

The changelog is also at the `PyCav module repository <https://github.com/PyCav/PyCav-Module>`_.
